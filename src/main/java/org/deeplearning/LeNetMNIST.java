...
public class LeNetMNIST {
    ...
    public static final String MODEL_PATH = FilenameUtils.concat(System.getProperty("java.io.tmpdir"), "lenetmnist.zip");
    ...
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        log.info("Saving model to tmp folder: " + MODEL_PATH);
