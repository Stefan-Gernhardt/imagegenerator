...
public class MNISTDoubleLayer {
    ...
    public static void main(String[] args) throws Exception {
        ...
        int numEpochs = 1; // 15 - number of epochs to perform
        ...
        INDArray input = Nd4j.create(new int[]{1, 784});
        List<INDArray> result = model.feedForward(input, false);
        System.out.println("result size: " + result.size());
        System.out.println("result: " + result.get(3).toString());
